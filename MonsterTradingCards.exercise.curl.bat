...
REM --------------------------------------------------
echo UniqueFeature) Create Sell Offer
echo should fail ... Card is in Deck
curl -X POST http://localhost:10001/sell --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d "{\"Id\":\"1\", \"CardId\":\"845f0dc7-37d0-426e-994e-43fc3ac83c08\", \"Price\": 5}"
echo.
echo.
curl -X POST http://localhost:10001/sell --header "Content-Type: application/json" --header "Authorization: Bearer kienboec-mtcgToken" -d "{\"Id\":\"1\", \"CardId\":\"55ef46c4-016c-4168-bc43-6b9b1e86414f\", \"Price\": 5}"
echo.
curl -X GET http://localhost:10001/sell --header "Authorization: Bearer kienboec-mtcgToken"
echo.
curl -X POST http://localhost:10001/sell/1 --header "Content-Type: application/json" --header "Authorization: Bearer altenhof-mtcgToken" -d ""
echo.
curl -X GET http://localhost:10001/sell --header "Authorization: Bearer kienboec-mtcgToken"
echo.
echo end...
